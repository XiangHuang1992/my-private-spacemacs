...
(defun huangxiang/smart-open-line ()
...
(defun huangxiang/rename-file-and-buffer ()
...
(defun huangxiang/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun huangxiang/dired-do-command (command)
...
(defun huangxiang/dired-up-directory()
  "goto up directory and resue buffer"
  (interactive)
  (find-alternate-file ".."))

(defun huangxiang/insert-space-after-point ()
  (interactive)
