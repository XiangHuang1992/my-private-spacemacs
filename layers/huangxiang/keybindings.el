;;; keybindings.el --- huangxiang Layer packages File for Spacemacs
;;
...
(global-set-key [(shift return)] 'huangxiang/smart-open-line)
(global-set-key (kbd "s-/") 'hippie-expand)
(global-set-key (kbd "C-c a") 'org-agenda)
(define-key global-map (kbd "C-c y") 'youdao-dictionary-search-at-point+)
(define-key global-map (kbd "<f9>") 'org-capture)
(define-key global-map (kbd "C-c t") 'org-capture)
(define-key global-map (kbd "<f8>") 'huangxiang/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'huangxiang/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'huangxiang/run-current-file)
...
(when (spacemacs/system-is-mac)
 (spacemacs/set-leader-keys "o!" 'huangxiang/iterm-shell-command))
...
;; (bind-key* "s-r" 'huangxiang/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'huangxiang/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'huangxiang/delete-semicolon-at-the-end-of-this-line)
(bind-key* "s-," 'huangxiang/insert-comma-at-the-end-of-this-line)
;; (bind-key* "C-s-," 'huangxiang/delete-comma-at-the-end-of-this-line)
(bind-key* "C-c l" 'huangxiang/insert-chrome-current-tab-url)
(bind-key* "C-=" 'er/expand-region)
(bind-key* "M--" 'huangxiang/goto-match-paren)
(bind-key* "C-c k" 'which-key-show-top-level)
(bind-key* "s-y" 'aya-expand)
(bind-key* "C-." 'huangxiang/insert-space-after-point)
...
(global-set-key (kbd "<f1>") 'huangxiang/helm-hotspots)
(spacemacs/set-leader-keys "oo" 'huangxiang/helm-hotspots)

(spacemacs/set-leader-keys "oc" 'my-auto-update-tags-when-save)
;; (spacemacs/set-leader-keys "op" 'huangxiang/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'huangxiang/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "ok" 'huangxiang-kill-other-persp-buffers)
(spacemacs/set-leader-keys "ox" 'org-open-at-point-global)
(spacemacs/set-leader-keys "or" 'huangxiang/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'huangxiang/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "oll" 'huangxiang/load-my-layout)
(spacemacs/set-leader-keys "ols" 'huangxiang/save-my-layout)
...
;; highlight
(spacemacs/set-leader-keys "hh" 'huangxiang/highlight-dwim)
(spacemacs/set-leader-keys "hc" 'huangxiang/clearn-highlight)
