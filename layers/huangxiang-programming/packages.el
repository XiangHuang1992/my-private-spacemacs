;;; packages.el --- huangxiang-programming layer packages file for Spacemacs.
;;
...
;; added to `huangxiang-programming-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `huangxiang-programming/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `huangxiang-programming/pre-init-PACKAGE' and/or
;;   `huangxiang-programming/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst huangxiang-programming-packages
  '(
    css-mode
    paredit
    lispy
  ...
  "The list of Lisp packages required by the huangxiang-programming layer.
...
(defun huangxiang-programming/init-compile-dwim ()
  (use-package compile-dwim
    :commands (compile-dwim-run compile-dwim-compile)
    :init))

(defun huangxiang-programming/init-exec-path-from-shell ()
  (use-package exec-path-from-shell
    :init
    (when (memq window-system '(mac ns))
      (exec-path-from-shell-initialize))))

(defun huangxiang-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun huangxiang/ruby-send-current-line (&optional print)
    ...
    (defun huangxiang/ruby-send-current-line-and-go ()
      (interactive)
      (huangxiang/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun huangxiang/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'huangxiang/ruby-send-current-line
        "sL" 'huangxiang/ruby-send-current-line-and-go
        "sI" 'huangxiang/start-inf-ruby-and-robe))))

(defun huangxiang-programming/init-caps-lock ()
  (use-package caps-lock
    :init
    (progn
      (bind-key* "s-e" 'caps-lock-mode))))

(defun huangxiang-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (huangxiang/git-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun huangxiang-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun huangxiang/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'huangxiang/cider-figwheel-repl))

(defun huangxiang-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun huangxiang-programming/post-init-dumb-jump ()
...
(defun huangxiang-programming/post-init-clojure-mode ()
  )

(defun huangxiang-programming/post-init-emacs-lisp ()
...
(defun huangxiang-programming/init-ctags-update ()
...
;; (defun huangxiang-programming/init-js-comint ()
...
(defun huangxiang-programming/post-init-web-mode ()
...
(defun huangxiang-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'huangxiang/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun huangxiang-programming/post-init-racket-mode ()
  (progn
...
(defun huangxiang-programming/post-init-json-mode ()
...
(defun huangxiang-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun huangxiang-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun huangxiang-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun huangxiang-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun huangxiang-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun huangxiang-programming/post-init-cmake-mode ()
  (progn
...
(defun huangxiang-programming/post-init-flycheck ()
...
(defun huangxiang-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun huangxiang-programming/post-init-js2-refactor ()
  (progn
...
(defun huangxiang-programming/post-init-js2-mode ()
  (progn
...
(defun huangxiang-programming/post-init-css-mode ()
  (progn
...
(defun huangxiang-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function huangxiang/init-<extension-name>
;;
(defun huangxiang-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun huangxiang-programming/init-nodejs-repl-eval ()
...
(defun huangxiang-programming/post-init-lua-mode ()
  (progn
...
(defun huangxiang-programming/post-init-cc-mode ()
  (progn
...
(defun huangxiang-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun huangxiang-programming/post-init-ycmd ()
  (progn
    ...
    (huangxiang|toggle-company-backends company-ycmd)
    (eval-after-load 'ycmd
      '(spacemacs|hide-lighter ycmd-mode))

    (spacemacs/set-leader-keys-for-major-mode 'c-mode
      "tb" 'huangxiang/company-toggle-company-ycmd)
    (spacemacs/set-leader-keys-for-major-mode 'c++-mode
      "tb" 'huangxiang/company-toggle-company-ycmd)))

;; when many project has the need to use tags, I will give etags-table and etags-update a try
(defun huangxiang-programming/init-etags-select ()
...
(defun huangxiang-programming/init-gulpjs ()
  (use-package gulpjs
    :init
    (progn
      (defun huangxiang/build-engine ()
        (interactive)
        (gulpjs-start-task-with-file-name "~/Github/fireball/app.js"))

      (spacemacs/set-leader-keys "ags" 'gulpjs-start-task)
      (spacemacs/set-leader-keys "agS" 'huangxiang/build-engine)
      (spacemacs/set-leader-keys "agr" 'gulpjs-restart-task))))


(defun huangxiang-programming/init-paredit ()
  (use-package paredit
...
(defun huangxiang-programming/post-init-company ()
  (progn
...
(defun huangxiang-programming/post-init-company-c-headers ()
  (progn
