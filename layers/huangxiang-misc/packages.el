;;; packages.el --- huangxiang-misc layer packages file for Spacemacs.
;;
...
;; added to `huangxiang-misc-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `huangxiang-misc/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `huangxiang-misc/pre-init-PACKAGE' and/or
;;   `huangxiang-misc/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst huangxiang-misc-packages
  '(
    helm-github-stars
    helm
    helm-ag
  ...
  "The list of Lisp packages required by the huangxiang-misc layer.
...
(defun huangxiang-misc/post-init-expand-region ()
...
(defun huangxiang-misc/init-browse-at-remote ()
  (use-package browse-at-remote
    :defer t
    :init (spacemacs/set-leader-keys "gho" 'browse-at-remote)))

(defun huangxiang-misc/init-highlight-global ()
...
(defun huangxiang-misc/init-symbol-overlay ()
...
(defun huangxiang-misc/post-init-golden-ratio ()
...
(defun huangxiang-misc/post-init-ranger ()
...
(defun huangxiang-misc/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
...
(defun huangxiang-misc/post-init-gist ()
  (use-package gist
    :defer t
    :init
...
(defun huangxiang-misc/init-peep-dired ()
...
(defun huangxiang-misc/post-init-flyspell-correct ()
  (progn
    (with-eval-after-load 'flyspell
      (define-key flyspell-mode-map (kbd "C-;") 'flyspell-correct-previous))
    (setq flyspell-correct-interface 'flyspell-correct-ivy)))

(defun huangxiang-misc/post-init-smartparens ()
...
(defun huangxiang-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun huangxiang-misc/post-init-helm ()
...
(defun huangxiang-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "huangxiang")))




(defun huangxiang-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun huangxiang-misc/post-init-command-log ()
...
(defun huangxiang-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun huangxiang-misc/init-osx-dictionary ()
...
(defun huangxiang-misc/init-4clojure ()
...
(defun huangxiang-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun huangxiang-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun huangxiang-misc/init-discover-my-major ()
...
(defun huangxiang-misc/post-init-elfeed ()
  (use-package elfeed
    :init
    ...
    (progn
      ...
      (defun huangxiang/elfeed-mark-all-as-read ()
        (interactive)
        (mark-whole-buffer)
        (elfeed-search-untag-all-unread))

      (define-key elfeed-search-mode-map (kbd "R") 'huangxiang/elfeed-mark-all-as-read)
...
(defun huangxiang-misc/post-init-evil ()
  (progn
    ...
    (define-key evil-normal-state-map
      (kbd "Y") 'huangxiang/yank-to-end-of-line)
    ...
    (define-key evil-visual-state-map (kbd "C-r") 'huangxiang/evil-quick-replace)
    ...
    ;; (defadvice evil-insert-state (around huangxiang/holy-mode activate)
...
(defun huangxiang-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun huangxiang-misc/init-visual-regexp-steroids ()
...
(defun huangxiang-misc/init-multiple-cursors ()
...
;;; Occasionally useful
    ...
    (setq mc/cmds-to-run-once
          '(
            counsel-M-x
            huangxiang/my-mc-mark-next-like-this))
...
(defun huangxiang-misc/post-init-persp-mode ()
  (setq persp-kill-foreign-buffer-behaviour 'kill)
  (setq persp-lighter nil)

  (defun huangxiang-kill-other-persp-buffers (&optional arg)
...
(defun huangxiang-misc/post-init-chinese-wbim ()
  (progn
...
(defun huangxiang-misc/post-init-evil-escape ()
  (setq evil-escape-delay 0.2))

(defun huangxiang-misc/init-find-file-in-project ()
...
(defun huangxiang-misc/post-init-projectile ()
  (progn
  ...
  current project. Otherwise do `occur' in the current file."
    ...
    (spacemacs/set-leader-keys "pf" 'huangxiang/open-file-with-projectile-or-counsel-git)
    (spacemacs/set-leader-keys "pt" 'my-simple-todo)))



(defun huangxiang-misc/post-init-prodigy ()
  (progn
    (prodigy-define-tag
      :name 'jekyll
    ...
    (defun refresh-chrome-current-tab (beg end length-before)
      (call-interactively 'huangxiang/browser-refresh--chrome-applescript))
...
(defun huangxiang-misc/init-moz-controller ()
...
(defun huangxiang-misc/init-ag ()
  (use-package ag
    :init))

(defun huangxiang-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun huangxiang-misc/init-wrap-region ()
...
(defun huangxiang-misc/init-keyfreq ()
  (use-package keyfreq
    :init
    (progn
      (keyfreq-mode t)
...
(defun huangxiang-misc/post-init-swiper ()
...
(defun huangxiang-misc/post-init-magit ()
  (progn
    ...
    (eval-after-load 'magit
      '(define-key magit-mode-map (kbd "C-c g")
         #'huangxiang/magit-visit-pull-request))

    (setq magit-process-popup-time 10)))

(defun huangxiang-misc/post-init-git-messenger ()
  (use-package git-messenger
    :defer t
    :config
    (progn
      (define-key git-messenger-map (kbd "f") 'huangxiang/github-browse-commit))))

(defun huangxiang-misc/post-init-markdown-mode ()
  (progn
