;;; packages.el --- huangxiang-ui layer packages file for Spacemacs.
;;
...
;; added to `huangxiang-ui-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `huangxiang-ui/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `huangxiang-ui/pre-init-PACKAGE' and/or
;;   `huangxiang-ui/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst huangxiang-ui-packages
  '(
    (huangxiang-mode-line :location built-in)
    diminish
    popwin
    (whitespace :location built-in)
    ;; hl-anything performance is very slow...
    ;; hl-anything
    ;; if you wnat to use spaceline, please comment out huangxiang-mode-line
    ;; spaceline
    ;; beacon
    ;; evil-vimish-fold
    )
  "The list of Lisp packages required by the huangxiang-ui layer.
...
(defun huangxiang-ui/init-huangxiang-mode-line ()
  (defun huangxiang/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (when (bound-and-true-p winum-mode) (propertize
                                                              ...
                                                              'font-lock-type-face)))
                 " "
                 '(:eval (huangxiang/modeline--evil-substitute))
                 '(:eval (huangxiang/update-persp-name))
                 ...
                 '(:eval (huangxiang/display-mode-indent-width))
                 ;; line and column
...
(defun huangxiang-ui/post-init-diminish ()
  (progn
...
(defun huangxiang-ui/post-init-spaceline ()
...
This segment overrides the modeline functionality of `org-mode-line-string'."
      ...
      (setq-default mode-line-format '("%e" (:eval (spaceline-ml-huangxiang))))
      )))

(defun huangxiang-ui/init-beacon ()
  (use-package beacon
    :init
    (progn
...
(defun huangxiang-ui/init-evil-vimish-fold ()
...
(defun huangxiang-ui/post-init-hl-anything ()
  (progn
...
(defun huangxiang-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun huangxiang-ui/post-init-popwin ()
  (progn
    ;FIXME: 
    ;; (push "*huangxiang/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun huangxiang-ui/post-init-whitespace ()
  (progn
